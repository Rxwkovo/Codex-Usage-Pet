...
class PetService:Service() {
    ...
    override fun onStartCommand(i:Intent?,flags:Int,startId:Int):Int {
        ...
        val n=Notification.Builder(this,"pet").setSmallIcon(R.drawable.ic_pet).setContentTitle("码团正在陪你")
        ...
        view.dragWindow={dx,dy->fx+=dx;fy+=dy;clamp(false);updateWindow();store.prefs.edit().putFloat("x",fx).putFloat("y",fy).apply()}
        clamp(false)
