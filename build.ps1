...
$files=@('pet.ps1','pet.ico','preferences-core.ps1','settings-ui.ps1','behavior-core.ps1','sprite-core.ps1','sprite-player.cs','assets','usage-core.ps1','read-usage.ps1','README.md','LICENSE') | ForEach-Object { Join-Path $PSScriptRoot $_ }
...
$output=Join-Path $dist 'Codex-Usage-Pet-v2.0.0.exe'
