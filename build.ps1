...
$files=@('pet.ps1','behavior-core.ps1','usage-core.ps1','read-usage.ps1','README.md','LICENSE') | ForEach-Object { Join-Path $PSScriptRoot $_ }
...
$output=Join-Path $dist 'Codex-Usage-Pet-v1.2.0.exe'
